...
GameView.prototype.checkDrag = function checkDrag(dragBeat, time) {
  ...
  var dragTime = dragBeat.length * 1000 / 60 / 2;
  var activeBeatT = 500;
...
GameView.prototype.drawDrag = function drawDrag(beat, time) {
  ...
  var activeBeatT = 500;
  var dragTime = beat.length * 1000 / 60 / 2;
  var addDragTime = Math.max(0, inactiveBeatT + activeBeatT - dragTime);
  var beatTime = inactiveBeatT + activeBeatT + dragTime;
  var radiusMul;
  var opacity;

  if (-timeDelta <= inactiveBeatT + activeBeatT && timeDelta <= inactiveBeatT + dragTime + addDragTime) {
